...
import { BUSINESS_EMAIL, BUSINESS_PHONE } from '@/lib/businessConstants';
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-8 sm:space-y-12">
          ...
          <section className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-8 frosted-glass">
            ...
            <p className="leading-relaxed text-sm sm:text-base text-muted-foreground tracking-wide">
              If you have any questions about this Privacy Policy, please contact us at {BUSINESS_EMAIL}
              {' '}or call us at {BUSINESS_PHONE}. You can also reach us through our contact page.
            </p>
          </section>
        </div>
      </div>
