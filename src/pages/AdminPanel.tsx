...
const AdminPanel: React.FC = () => {
  ...
  const handleSaveBlogPost = async () => {
    try {
      ...
      if (selectedBlog) {
        ...
        toast({
          title: 'Blog Updated',
          description: `"${blogFormData.title}" has been updated.`
        });
      } else {
        ...
        toast({
          title: 'Blog Created',
          description: `"${blogFormData.title}" has been created.`
        });
      }
  ...
  const handleDeleteBlogPost = async () => {
    ...
    try {
      ...
      toast({
        title: 'Blog Deleted',
        description: `"${selectedBlog.title}" has been deleted.`
      });
  ...
  const handleTogglePublish = async (blog: BlogPost) => {
    try {
      ...
      toast({
        ...
        description: `"${blog.title}" is now ${blog.is_published ? 'a draft' : 'published'}.`
      });
  ...
  const openEditBlogModal = (blog: BlogPost) => {
    ...
    setBlogFormData({
      ...
      category: blog.category || 'Beauty Tips',
    ...
    <TooltipProvider>
      <div className="min-h-screen bg-white text-black" data-theme="light" style={{ colorScheme: 'light' }}>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-blue-600">Non-cancelled appointments</p>
                      </div>
            ...
            <>
              ...
              <Card className="border-gray-200 bg-white">
                <Table className="bg-white">
                  <TableHeader className="bg-gray-100">
                    <TableRow className="bg-gray-100 hover:bg-gray-100">
                      <TableHead className="text-black font-semibold bg-gray-100">Title</TableHead>
                      <TableHead className="text-black font-semibold bg-gray-100">Category</TableHead>
                      <TableHead className="text-black font-semibold bg-gray-100">Author</TableHead>
                      <TableHead className="text-black font-semibold bg-gray-100">Status</TableHead>
                      <TableHead className="text-black font-semibold bg-gray-100">Created</TableHead>
                      <TableHead className="text-black font-semibold text-right bg-gray-100">Actions</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody className="bg-white">
                    {blogLoading ? (
                      ...
                      .filter(post =>
                        ...
                        post.author_name?.toLowerCase().includes(blogSearchQuery.toLowerCase())
                      )
                      .length === 0 ? (
                      <TableRow className="bg-white hover:bg-white">
                        <TableCell colSpan={6} className="text-center py-12 bg-white">
                          <div className="text-gray-500">
                            ...
                            <p className="text-sm mt-1">
                              {blogSearchQuery ? 'No posts match your search.' : 'Create your first blog post to get started.'}
                            </p>
                          </div>
                        </TableCell>
                      </TableRow>
                      ...
                      blogPosts
                        ...
                        .map((post) => (
                          <TableRow key={post.id} className="bg-white hover:bg-gray-50">
                            ...
                            <TableCell className="text-black">{post.author_name}</TableCell>
                            <TableCell>
                              <div className="flex items-center gap-2">
                                <Switch
                                  ...
                                  className="data-[state=checked]:bg-green-500 data-[state=unchecked]:bg-gray-300"
                                />
                                <span className={`text-sm ${post.is_published ? 'text-green-600' : 'text-gray-500'}`}>
                    ...
                    {enterpriseLoading ? (
                      ...
                      crmProfiles.slice(0, 10).map((profile) => (
                        <TableRow key={profile.id} className="hover:bg-gray-50">
                          ...
                          <TableCell>
                            <Badge className="bg-blue-100 text-blue-700">{profile.lifecycle_stage_id || 'New'}</Badge>
                          </TableCell>
                          <TableCell>
                            <Badge className={
                    ...
                    {enterpriseLoading ? (
                      ...
                      forecasts.slice(0, 10).map((forecast) => (
                        <TableRow key={forecast.id} className="hover:bg-gray-50">
                          ...
                          <TableCell>
                            <Badge className="bg-blue-100 text-blue-700">{forecast.service_category}</Badge>
                          </TableCell>
                    ...
                    {enterpriseLoading ? (
                      ...
                      campaigns.slice(0, 10).map((campaign) => (
                        <TableRow key={campaign.id} className="hover:bg-gray-50">
                          ...
                          <TableCell>
                            <Badge className="bg-blue-100 text-blue-700">{campaign.campaign_type}</Badge>
                          </TableCell>
                          <TableCell>
                            <Badge className={
                ...
                <Card className="bg-white border-gray-200">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                        <RefreshCw className={`h-5 w-5 text-blue-600 ${syncStatus.syncing ? 'animate-spin' : ''}`} />
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <Dialog open={showBlogModal} onOpenChange={setShowBlogModal}>
          <DialogContent className="bg-white border-gray-200 text-black max-w-2xl" style={{ backgroundColor: 'white' }}>
            <DialogHeader>
              <DialogTitle className="text-black">
                {selectedBlog ? 'Edit Blog Post' : 'Create New Blog Post'}
              </DialogTitle>
              <DialogDescription className="text-gray-600">
                {selectedBlog ? 'Update the blog post details' : 'Fill in the details for your new blog post'}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4 max-h-[60vh] overflow-y-auto">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setBlogFormData({
                      ...blogFormData,
                      title: newTitle,
                      // Always regenerate slug from title unless user manually edited slug field
                      slug: slugManuallyEdited ? blogFormData.slug : generateSlug(newTitle)
                    });
                  }}
                  className="border-gray-300 text-black bg-white"
                  style={{ backgroundColor: 'white', color: 'black' }}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium text-black">Read Time</label>
                  <Input
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-20 px-3 py-2 border border-gray-300 rounded-md text-black bg-white resize-none"
                  style={{ backgroundColor: 'white', color: 'black' }}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-40 px-3 py-2 border border-gray-300 rounded-md text-black bg-white resize-none"
                  style={{ backgroundColor: 'white', color: 'black' }}
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-black">
                  {blogFormData.is_published ? 'Published' : 'Save as Draft'}
                </span>
              </div>
            </div>
            <DialogFooter>
              ...
              <Button
                ...
                disabled={!blogFormData.title || !blogFormData.content}
                className="bg-blue-600 hover:bg-blue-700 text-white"
              >
        ...
        <AlertDialog open={showDeleteBlogDialog} onOpenChange={setShowDeleteBlogDialog}>
          <AlertDialogContent className="bg-white border-gray-200" style={{ backgroundColor: 'white' }}>
            <AlertDialogHeader>
              <AlertDialogTitle className="text-black">Delete Blog Post</AlertDialogTitle>
              <AlertDialogDescription className="text-gray-600">
