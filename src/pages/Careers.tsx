...
export default function Careers() {
  ...
  const handleApplyClick = (jobTitle: string) => {
    ...
    setTimeout(() => {
      ...
      if (formElement) {
        scrollToElement(formElement, 80);
      }
    }, 150);
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      <div className="careers-title pt-24 pb-3 px-4 md:px-8 text-center">
        <h1
          className="text-4xl md:text-5xl lg:text-6xl font-normal tracking-[0.4em] uppercase luxury-glow text-hover-shimmer"
          style={{
            fontFamily: "'Cormorant Garamond', serif",
            letterSpacing: '0.4em',
            color: '#ffffff',
            opacity: 1,
            textShadow: '0 0 8px rgba(255,255,255,0.6), 0 0 15px rgba(255,255,255,0.4), 0 0 25px rgba(255,255,255,0.2)'
          }}
        >
          CAREERS
        </h1>
      ...
      {/* Content Section */}
      <div className="careers-content py-4 md:py-0 px-4 md:px-8">
