          ...
          {loading ? (
            ...
            Object.keys(filteredServices).map((category) => (
              <motion.div
                ...
                className="service-category scroll-mt-24"
                initial="hidden"
                whileInView="visible"
              ...
              >
                <motion.h2
                  className="text-3xl md:text-4xl lg:text-5xl font-serif mb-8 md:mb-12 pb-4 border-b border-white/10 luxury-glow"
                ...
                >
                  {filteredServices[category].map((item: any) => (
                    <motion.div
                      key={item.id}
                      className="group flex flex-col md:flex-row items-start md:items-center justify-between p-6 md:p-8 frosted-glass border border-white/10 cursor-hover rounded-xl"
