    ...
    <form onSubmit={handleSignIn} className="space-y-4 sm:space-y-5">
      ...
      <div className="space-y-1.5 sm:space-y-2">
        ...
        <Input
          ...
          className="bg-black border border-white/30 text-white placeholder-gray-500 focus:ring-white/50 focus:border-white text-base sm:text-lg py-2.5 sm:py-3"
          required
        />
      </div>
      ...
      <div className="space-y-1.5 sm:space-y-2">
        ...
        <div className="relative">
          <Input
            ...
            className="bg-black border border-white/30 text-white placeholder-gray-500 focus:ring-white/50 focus:border-white text-base sm:text-lg py-2.5 sm:py-3 pr-10"
            required
          />
          <button
            type="button"
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          <TabsContent value="sign-in" className="w-full">
            <div className="bg-black border border-white/20 rounded-lg p-3 sm:p-5 md:p-6 lg:p-8 shadow-[0_0_30px_rgba(255,255,255,0.05)] w-full overflow-hidden">
              <CustomSignInForm appearance={clerkAppearance} />
            </div>
          </TabsContent>
