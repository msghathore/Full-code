...
import { SuccessConfettiAnimation, SparkleAnimation, scrollToTop } from '@/components/animations';
    ...
    return (
      <div className="min-h-screen bg-black flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 pt-20 relative overflow-hidden">
          {/* Sparkle animations for celebration effect */}
          ...
          <div className="absolute bottom-40 left-1/3 opacity-40">
            <SparkleAnimation className="w-10 h-10" />
          </div>
          <div className="absolute bottom-32 right-1/3 opacity-50">
            <SparkleAnimation className="w-6 h-6" />
          </div>
