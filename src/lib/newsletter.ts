...
// Implemented with Brevo API using their official documentation

const BREVO_API_KEY = 'REMOVED_API_KEY';
const SENDER_EMAIL = 'email@zavira.ca';
...
export class NewsletterService {
  ...
  private static async sendWelcomeEmail(email: string, name?: string) {
    try {
      ...
      console.log('🔑 Brevo API Key available:', BREVO_API_KEY ? 'YES' : 'NO');
