...
export const PAYMENT_ICONS = {
  ...
  membership: { icon: Users, color: 'text-blue-600', bgColor: 'bg-blue-100', tooltip: 'Paid with membership' },
  pending: { icon: AlertCircle, color: 'text-red-600', bgColor: 'bg-red-100', tooltip: 'Payment pending' }
};

export const ATTRIBUTE_ICONS = {
  recurring: { icon: Repeat, color: 'text-blue-600', tooltip: 'Recurring appointment' },
