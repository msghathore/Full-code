      ...
      <div className="mb-8">
        ...
        <div className="text-center mt-8">
          <a
            ...
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-500 to-white/30 text-white rounded-full hover:from-red-600 hover:to-white/30 transition-all transform hover:scale-105"
          >
