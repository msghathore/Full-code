                  ...
                  {getAppointmentsForSlot(staffMember.id, selectedDate, 'all').map(appointment => {
                    ...
                    return (
                      <div
                        ...
                        className="absolute left-2 right-2 p-2 rounded-lg shadow-md cursor-pointer text-white bg-blue-600 hover:bg-blue-700 transition-colors z-20 overflow-hidden"
                      >
