...
const CookieConsent: React.FC = () => {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-[9999] p-2 sm:p-4 bg-black border-t border-white/20"
      style={{
        backdropFilter: 'none',
        filter: 'none',
    ...
    >
      {!showSettings ? (
        <Card
          className="max-w-none sm:max-w-4xl mx-auto bg-black border-white/20 shadow-2xl"
          style={{
            backgroundColor: '#000000',
            backdropFilter: 'none',
            filter: 'none'
          ...
          <CardContent className="p-3 sm:p-6">
            <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-base sm:text-lg mb-3 text-white">Cookie Preferences</h3>
                <p
                  className="text-sm sm:text-base text-white/90 mb-4 leading-relaxed"
                  style={{
                    filter: 'none',
                    textShadow: 'none',
                    backdropFilter: 'none',
        ...
        <Card
          className="max-w-none sm:max-w-2xl mx-auto bg-black border-white/20 shadow-2xl"
          style={{
            backgroundColor: '#000000',
            backdropFilter: 'none',
            filter: 'none'
        ...
        >
          ...
          <CardContent className="space-y-3 sm:space-y-4 pt-0">
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1 pr-2">
                  <h4 className="font-medium text-white text text-sm sm:text-base">Functional Cookies</h4>
                  <p
                    className="text-xs sm:text-sm text-white/70"
                    style={{
                      filter: 'none',
