...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 left-1/2 -translate-x-1/2 z-[10000] flex max-h-screen w-full flex-col-reverse p-4 sm:left-auto sm:right-0 sm:translate-x-0 sm:flex-col md:max-w-[420px]",
      className,
    )}
    {...props}
  />
