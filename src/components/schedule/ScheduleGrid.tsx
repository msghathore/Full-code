      ...
      {isOver && dropPreviewY !== null && dropPreviewTime && (
        ...
        >
          ...
          <div className="absolute -top-5 left-0 flex items-center gap-1">
            <div className="bg-blue-500 text-white text-[10px] font-bold px-2 py-0.5 rounded shadow-lg whitespace-nowrap">
              {dropPreviewTime}
            </div>
          </div>
          {/* Top line showing exact drop position */}
          <div className="h-[2px] bg-blue-500 rounded shadow-lg" />
          {/* Preview outline showing where pill will be placed - starts exactly at dropPreviewY */}
          <div
            className="border-2 border-dashed border-blue-400 rounded bg-blue-100/30"
            style={{
