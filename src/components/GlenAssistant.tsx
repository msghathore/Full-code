    ...
    <>
      ...
      >
        ...
        <Button
          ...
          className="relative rounded-full w-16 h-16 p-0 border-0 transition-all duration-300 bg-white hover:bg-white/95 text-black"
          style={{
            boxShadow: isOpen
              ? '0 8px 30px rgba(255, 255, 255, 0.3), 0 0 20px rgba(255,255,255,0.2)'
              : '0 12px 40px rgba(255, 255, 255, 0.25), 0 0 60px rgba(255, 255, 255, 0.15), inset 0 1px 0 rgba(255,255,255,0.5)'
          }}
          size="icon"
        >
          <AnimatePresence mode="wait">
