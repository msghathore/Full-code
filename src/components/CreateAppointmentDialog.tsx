...
const GROUP_TYPES = [
  ...
  { value: 'corporate', label: 'Corporate Event', icon: Users, color: 'bg-blue-100 text-blue-600 border-blue-200' },
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              >
                <SelectTrigger className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.service_id ? 'border-red-500' : ''
                  }`}>
                      ...
                      <>
                        {customerResults.map((customer) => (
                          <button
                            key={customer.id}
                            type="button"
                            className="w-full px-3 py-2 text-left hover:bg-blue-50 border-b last:border-b-0 text-black transition-colors"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input
                    ...
                    className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.first_name ? 'border-red-500' : ''}`}
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.last_name ? 'border-red-500' : ''}`}
                  />
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                type="date"
                className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.appointment_date ? 'border-red-500' : ''
                  }`}
              />
            ...
            <div>
              ...
              <Select value={formData.appointment_time} onValueChange={(value) => setFormData(prev => ({ ...prev, appointment_time: value }))}>
                <SelectTrigger className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.appointment_time ? 'border-red-500' : ''
                  }`}>
            ...
            <div>
              ...
              <Select value={formData.staff_id} onValueChange={(value) => setFormData(prev => ({ ...prev, staff_id: value }))}>
                <SelectTrigger className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.staff_id ? 'border-red-500' : ''
                  }`}>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                step="0.01"
                placeholder="0.00"
                className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.total_amount ? 'border-red-500' : ''
                  }`}
              />
              {errors.total_amount && (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                maxLength={14}
                className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.phone ? 'border-red-500' : ''
                  }`}
              />
              {errors.phone && (
            ...
            <div>
              ...
              <Input
                ...
                type="email"
                className={`bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${errors.email ? 'border-red-500' : ''
                  }`}
              />
              {errors.email && (
          ...
          <div className="space-y-1">
            <Input
              ...
              className="bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm"
            />
