        ...
        <div className="space-y-4">
          <div>
            ...
            <Textarea
              ...
              className="w-full min-h-[120px] p-3 border border-gray-300 rounded-lg text-sm resize-none focus:border-blue-500 focus:ring-blue-500 bg-white text-black placeholder:text-gray-500"
              disabled={isLoading}
            />
